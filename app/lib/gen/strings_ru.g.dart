...
class _TranslationsReceiveOptionsPageRu extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(Папка YiDrop)';
  @override
...
class _TranslationsWebSharePageRu extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'YiDrop использует самоподписанный сертификат. Вам необходимо принять его в браузере.';
  @override
...
class _TranslationsAboutPageRu extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'О YiDrop';
  @override
  List<String> get description => [
        'YiDrop — это бесплатное приложение с открытым исходным кодом, которое позволяет вам безопасно обмениваться файлами и сообщениями с находящимися поблизости устройствами через локальную сеть, без необходимости подключения к Интернету.',
...
class _TranslationsDonationPageRu extends TranslationsDonationPageEn {
  ...
  @override
  String get info =>
      'YiDrop — это бесплатное приложение с открытым исходным кодом и без рекламы. Если оно вам нравится, вы можете поддержать его разработку пожертвованием.';
  @override
...
class _TranslationsTrayRu extends TranslationsTrayEn {
  ...
  @override
  String get close => 'Выйти из YiDrop';
  @override
...
class _TranslationsSettingsTabGeneralRu extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'Отображать YiDrop в контекстном меню';
  @override
...
class _TranslationsSettingsTabOtherRu extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'Поддержать YiDrop';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedRu extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'YiDrop не может найти другие устройства без разрешения на сканирование локальной сети. Пожалуйста, предоставьте это разрешение в настройках.';
  @override
...
class _TranslationsDialogsSendModeHelpRu extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'Получатели, у которых не установлен YiDrop, могут загрузить выбранные файлы, открыв ссылку в своем браузере.';
}
