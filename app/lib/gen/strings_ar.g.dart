...
class _TranslationsWebSharePageAr extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'يستخدم تطبيق YiDrop شهادة موقع ذاتية التوقيع. يجب عليك قبولها في المتصفح.';
  @override
...
class _TranslationsAboutPageAr extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'عن YiDrop';
  @override
  List<String> get description => [
        'YiDrop هو تطبيق مجاني مفتوح المصدر يسمح لك بمشاركة الملفات والرسائل بشكل آمن مع الأجهزة القريبة عبر شبكتك المحلية دون الحاجة إلى اتصال بالإنترنت.',
...
class _TranslationsDonationPageAr extends TranslationsDonationPageEn {
  ...
  @override
  String get info => 'YiDrop مجاني ومفتوح المصدر وبدون أي إعلانات. إذا أعجبك التطبيق، يمكنك دعم التطوير بالتبرع.';
  @override
...
class _TranslationsSettingsTabGeneralAr extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'إظهار YiDrop في قائمة السياق';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedAr extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  @override
  String get description => 'لا يمكن ل YiDrop العثور على الأجهزة الأخرى بدون الإذن بفحص الشبكة المحلية. يرجى منح هذا الإذن في الإعدادات.';
  @override
...
class _TranslationsDialogsSendModeHelpAr extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'يمكن للمستلمين الذين لا يحتوون على YiDrop تنزيل الملفات المحددة عن طريق فتح الرابط في متصفحهم.';
}
